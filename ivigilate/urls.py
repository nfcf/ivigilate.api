...
urlpatterns = patterns('',
    ...
    url(r'^api/v1/provisiondevice/$', views_api.ProvisionDeviceView.as_view(), name='provisionDevice'),
    ...
    url(r'^api/v1/localevents/$', views_api.LocalEventsView.as_view(), name='localevents'),
