(function () {
    ...
    AddEventController.$inject = ['$location', '$scope', '$filter', '$modalInstance', 'data', 'Authentication', 'Places', 'Movables', 'Sightings'];

    function AddEventController($location, $scope, $filter, $modalInstance, data, Authentication, Places, Movables, Sightings) {
        var vm = this;
